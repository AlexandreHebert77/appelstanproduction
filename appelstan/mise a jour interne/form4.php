...
<html>
    ...
    <body>
        <h1>Mise à jour place interne</h1>
        ...
        if (isset ($_POST['valider'])){
            ...
            $req = $bdd->prepare('UPDATE interne SET place=? WHERE Nom=? and Prenom=?');
            $req->execute(array($Place,$Nom,$Prenon,));
        
            //connectMaBase();
            //$sql = 'UPDATE interne SET place="'.$place.'" WHERE Nom="'.$Nom.'" and Prenom="'.$Prenom.'"'; 
